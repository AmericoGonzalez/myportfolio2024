...
export function ThreeDCardDemo() {
  return (
    <div className="flex flex-col md:flex-row justify-center space-x-8">
      <CardContainer className="w-100 h-100 p-2">
        <CardBody
          className="  
 ...
 border w-auto h-auto sm:w-[30rem] rounded-xl p-6"
        >
          ...
          >
            ...
            fluent in Spanish and English. I hold a Bachelor’s degree in History
            and Geography, which provided me with a strong foundation in
            ...
            thinking, business knowledge, and technical skills.
          </CardItem>
        </CardBody>
      </CardContainer>
    </div>
