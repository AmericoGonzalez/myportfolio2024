    ...
    <div className="text-center">
      ...
      <div className="flex flex-col md:flex-row justify-center">
        <div className="flex items-center justify-center mb-6">
          <div className="w-100 h-140 mx-4 p-4 border-2 border-grey rounded-xl">
            ...
            <p>
              The dashboard will update automatically. You will notice simulated
              slow data created to apply loading skeletons.
            </p>
      ...
      <div className="flex items-center justify-center mb-6">
        <div className="w-100 h-140 mx-4 p-4 border-2 border-grey rounded-xl">
          ...
          <p>
            This is a simple chat app that I made with Node.js, Bootstrap,
            Socket.io, and a MongoDB Atlas.
          </p>
