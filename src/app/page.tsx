    ...
    <div className="text-center">
      ...
      <div className="wrapper mt-5 border-t-2 border-b-2 border-red-600 flex items-center justify-center">
        ...
        <div className="item item5 flex items-center justify-center">
          <p className="pr-2">Vercel</p>
          <SiVercel size={20} title="Vercel" />
        </div>
      ...
      <h2 id="Projects" className="text-2xl mt-10 mb-5 pt-3">
        Projects
      </h2>
      ...
      <div className="flex items-center justify-center mb-6">
        <div className="w-100 h-140 mx-4 p-4 border-2 border-grey rounded-xl">
          ...
          <p>
            Create, manage, classify, update, and track customer support tickets
            in a clean full-stack application built with Next.js and PostgreSQL.
          </p>

          <br />

          <Link href="https://ai-support-system-tau.vercel.app/">
      ...
      <div className="flex flex-col md:flex-row justify-center">
        <div className="flex items-center justify-center mb-6">
          <div className="w-100 h-140 mx-4 p-4 border-2 border-grey rounded-xl">
            ...
            <p>
              This is a simplified version of a financial dashboard that I made
              following the course Learn Next.js in the website of Next.js.
            </p>
            <p>
              You can add, edit, and delete invoices in an accompanying DB
              provided for Vercel.
            </p>
        ...
        <div className="flex flex-col items-center justify-center mb-6">
          <div className="w-100 h-140 mx-4 p-4 border-2 border-grey rounded-xl">
            ...
            <p>
              This is a form that calculates the score that inmigrants can
              obtain to apply for the BC Provincial Nominee Program.
            </p>
      ...
      <h2 id="Skills" className="text-2xl mt-10 mb-2 pt-3">
        Skills
      </h2>
      <br />
      <div className="flex flex-col md:flex-row justify-center">
      ...
      <h2 id="Contact" className="text-2xl mt-10 mb-2 pt-3">
        Contact me
      </h2>
      <br />
      <ContactForm />
      <footer className="flex justify-center space-x-8 text-center mt-14 border-2 border-gray-100 py-10">
        <div>
          <p>&copy; 2024 - 2025 Americo Gonzalez</p>
        </div>
        <br />
        <Link href="https://www.linkedin.com/in/americo-gonzalez-82702630/">
          <div className="">
            <SlSocialLinkedin size={25} title="LinkedIn" />
          </div>
        </Link>
        <Link href="https://github.com/AmericoGonzalez">
          <div className="">
            <BsGithub size={25} title="github" />
          </div>
        </Link>
